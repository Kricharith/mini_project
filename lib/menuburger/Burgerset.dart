...
class Burgerset extends StatefulWidget {
  ...
  @override
  State<Burgerset> createState() => _BurgerState();
}

class _BurgerState extends State<Burgerset> {
    ...
    return Scaffold(
            ...
            Center(
              child: Column(
                children: [
                  ...
                  Text("Burgerset", style: TextStyle(fontSize: 40)),
                ],
              ),
            ),
            Positioned.fill(
      ...
      body: Container(
        decoration: BoxDecoration(
          ...
          Color.fromARGB(255, 117, 247, 84),
          Color.fromARGB(255, 201, 255, 191),
          Color.fromARGB(255, 97, 249, 105)
